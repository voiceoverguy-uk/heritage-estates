...
export default function SelfEmployed() {
  return (
    <>
      <Helmet>
        <title>Get your Self Employed Mortgage Application approved with Heritage Estates</title>
        <meta name="description" content="Heritage Estates help self-employed people get mortgage applications approved. Whole of market access to specialist and regular lenders in Leicester." />
      </Helmet>
